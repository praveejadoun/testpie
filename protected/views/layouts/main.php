      	...
      	<div class="nav">
        	<ul id="sortable1" class="connectedSortable">
             <!--   <li>
				...
				{
				    echo CHtml::link(Yii::t('app','Dashboard'), array('/dashboard'),array('class'=>'ic14 active'));
				}
				else
				{
					echo CHtml::link(Yii::t('app','Dashboard'), array('/dashboard'),array('class'=>'ic14'));
				}*/
				?>
                </li>   --> 
            	...
            	<li>
				 ...
				 if(Yii::app()->controller->module->id=='mailbox'||Yii::app()->controller->module->id=='' ||Yii::app()->controller->module->id=='cal')
				 {
				 echo CHtml::link(Yii::t('app','Dashboard'), array('/default'),array('class'=>'ic1 active'));
				 }else{
					 echo CHtml::link(Yii::t('app','Dashboard'), array('/default'),array('class'=>'ic1'));
				 }
                ...
                <li>
                <?php 
                if(isset(Yii::app()->controller->module->id) and Yii::app()->controller->module->id=='students')
				{
              ...
              <li>
                ...
                <li>
                 <?php 
				if(Yii::app()->controller->id=='configurations' or  Yii::app()->controller->id=='subjectName' or Yii::app()->controller->id=='user' or in_array(Yii::app()->controller->id,array('admin','profile','profileField')) or Yii::app()->controller->id=='edit' or Yii::app()->controller->id=='academicYears')
				{
      	...
      	<div class="nav">
        	<ul id="sortable2" class="connectedSortable">
               ...
               <li>
				...
				{
				    echo CHtml::link(Yii::t('app','Import'), array('/importcsv'),array('class'=>'ic18 active'));
				}
				else
				{
					echo CHtml::link(Yii::t('app','Import'), array('/importcsv'),array('class'=>'ic18'));
				}
				?>
                </li>
				...
				{
				    echo CHtml::link(Yii::t('app','Export'), array('/export'),array('class'=>'ic18 active'));
				}
				else
				{
					echo CHtml::link(Yii::t('app','Export'), array('/export'),array('class'=>'ic18'));
				}
				?>
                </li>
				...
				if(isset(Yii::app()->controller->module->id) and Yii::app()->controller->module->id=='report')
				{
				    echo CHtml::link(Yii::t('app','Sunil'), array('/sunil'),array('class'=>'ic6 active'));
				}
				else
				{
					echo CHtml::link(Yii::t('app','Sunil'), array('/sunil'),array('class'=>'ic6'));
				}
				?>
                </li>
