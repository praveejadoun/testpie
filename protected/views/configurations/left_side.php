			...
			function t($message, $category = 'cms', $params = array(), $source = null, $language = null) 
{
    return $message;
			...
			'items'=>array(
					...
					array('label'=>''.Yii::t('settings','General Settings<span>Manage Configurations</span>'),  'url'=>array('/configurations/index'),'active'=> ((Yii::app()->controller->id=='configurations') && (in_array(Yii::app()->controller->action->id,array('create','index')))),'linkOptions'=>array('class'=>'gs_ico' ), 'itemOptions'=>array('id'=>'menu_1'),
					       ),
						  ...
						  array('label'=>Yii::t('settings','Change Password<span>Manage All Users</span>'), 'url'=>array('/user/profile/changepassword'),'linkOptions'=>array('class'=>'cp_ico' )),
					...
					array('label'=>''.Yii::t('settings','<h1>Courses & Batches</h1>')),
						...
						array('label'=>Yii::t('settings','Create Courses<span>Add New Course Details</span>'), 'url'=>array('/courses/courses/create'),
							'active'=> ((Yii::app()->controller->id=='courses') && (in_array(Yii::app()->controller->action->id,array('update','view','admin','index'))) ? true : false),'linkOptions'=>array('class'=>'ne_ico' )),
							//array('label'=>''.Yii::t('settings','<h1>Import</h1>')),
					       
						//array('label'=>Yii::t('settings','Import All<span>All</span>'), 'url'=>array('/importcsv'),'active'=> ((Yii::app()->controller->module->id=='importcsv') ? true : false),'linkOptions'=>array('class'=>'sl_ico' )),
