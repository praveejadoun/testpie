...
class NotificationsController extends RController
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','roomchange','sendmails','Manage','savesearch','DisplaySavedImage','pdf','Address','Contact','Addinfo','Remove'),
				'users'=>array('@'),
			),
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('searchroom','update','batch','add'),
				'users'=>array('@'),
			),
		...
		if(isset($_POST['Employees']))
		{
			...
			*/
			...
			//{
				...
				if($model->save())
				{
				$this->redirect(array('roomchange','id'=>$model->id));
				}
			//}
		}

		$this->render('searchroom',array(
			'model'=>$model,
		));
	}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Employees']))
		{
			...
			if($model->save())
				$this->redirect(array('sendmails','id'=>$model->id));
		}
