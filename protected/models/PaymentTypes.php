...
/**
 * This is the model class for table "fees_payment_types".
 *
 * The followings are the available columns in table 'fees_payment_types':
 * @property integer $id
...
//			array('name','CRegularExpressionValidator', 'pattern'=>'/^[A-Za-z_ ]+$/','message'=>"{attribute} should contain only letters."),
			array('id, type, status, created_at, updated_at', 'safe', 'on'=>'search'),
