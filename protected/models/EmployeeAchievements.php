...
//                            ),
                     array('achievement_title,achievement_description,achievement_document_name', 'match','pattern' => '/^[a-zA-Z\s]+$/','message' => 'It can only contain alphabets,space'),
                     array('achievdoc_file_name', 'file','types'=>'jpg, gif, png', 'allowEmpty'=>true),
