...
//                    array('length', 'max'=>255, 'on'=>'insert,update'),
            array('document_data,created_at, updated_at', 'safe'),
            array('document_name,document_data', 'required'),
            array('document_name', 'match', 'pattern' => '/^[a-zA-Z\s]+$/', 'message' => 'It can only contain alphabets,space'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('document_data', 'file', 'types' => 'jpg, png', 'allowEmpty' => false, 'maxSize' => 5242880),
            array('id, student_id, document_name, document_file_name, document_content_type, document_data, created_at, updated_at, is_active, is_deleted, document_file_size', 'safe', 'on' => 'search'),
