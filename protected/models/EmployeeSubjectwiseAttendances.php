 ...
 */
class EmployeeSubjectwiseAttendances extends CActiveRecord
{
	/**
	...
	{
		return 'employee_subjectwise_attendances';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, attendance_date, batch_id, class_timing_id, employee_id, employee_leave_type_id, reason, is_half_day', 'safe', 'on'=>'search'),
		);
	}
