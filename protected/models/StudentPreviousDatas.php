...
class StudentPreviousDatas extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('institution,course,year,total_mark', 'required'),
            array('institution, year, course, total_mark', 'length', 'max' => 255),
            array('institution', 'match', 'pattern' => '/^[a-zA-Z\s]+$/', 'message' => 'It can only contain alphabets,space'),
            array('course', 'match', 'pattern' => '/^[A-Za-z0-9\s.\/]+$/', 'message' => 'It contains only alphanumeric,space,.,/'),
            array('total_mark', 'match', 'pattern' => '/^[0-9.]+$/', 'message' => 'It can only contain numbers(0-9,.)'),
