...
<?php   $formId='subjects-form';
   ...
   ($model->isNewRecord)?CController::createUrl('teacherSubjectAttendance/ajax_create')
    ...
    $form=$this->beginWidget('CActiveForm', array(
     'id'=>'teachersubjectattendance-form',
...
//	{
	?>
<!--        <div class="row">
			<?php // echo $form->labelEx($model,Yii::t('Subjects','employee_leave_type_id'), array('style'=>'color:#000000')); ?>
            <?php 
//			 $criteria  = new CDbCriteria;
//		     $criteria ->compare('is_deleted',0); 
//			echo $form->dropDownList($model, 'employee_leave_type_id', CHtml::listData(EmployeeLeaveTypes::model()->findAll(),'id','name'),array('prompt'=>'Select'));
			?>
...
//	}
    ...
    <div class="row">
        <?php 
            ...
            echo $form->labelEx($model,Yii::t('EmployeeSubjectWiseAttendance','employee_leave_type_id'), array('style'=>'color:#000000')); 
    ...
    <div class="row">
            <?php echo $form->labelEx($model,Yii::t('Subjects','reason'), array('style'=>'color:#000000')); ?>
