...
echo '<br/></div></div>';
 ...
 ?>
	...
	{  
            ...
            $d_1 = strtotime($year ."W". $week . 0);
            $d_2 = strtotime($year ."W". $week . 6);
            ?>


 <div align="center" class="atnd_tnav" style="top:367px;right:68%">
            <?php 
                echo CHtml::link('<div class="atnd_arow_l"><img src="images/atnd_arrow-l.png" width="7" border="0"  height="13" /></div>', array('create', 'dep'=>$_REQUEST['dep'],'emp'=>$_REQUEST['emp'],'week'=>($week == 1 ? 52 : $week -1),'year'=>($week == 1 ? $year - 1 : $year)));  echo date('M d', $d_1).'&nbsp;-&nbsp; '.date('M d', $d_2); echo CHtml::link('<div class="atnd_arow_r"><img src="images/atnd_arrow.png" border="0" width="7"  height="13" /></div>',array('create', 'dep'=>$_REQUEST['dep'],'emp'=>$_REQUEST['emp'],'week'=>($week == 52 ? 1 : 1 + $week),'year'=>($week == 52 ? 1 + $year : $year)));
            ?>
        </div>
<br/>
<br/>
