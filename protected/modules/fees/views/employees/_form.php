<!--<div class="captionWrapper">
	<ul>
    	<li><h2  class="cur">Create Fees</h2></li>
...
<table width="75%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="bottom" style="padding-bottom:3px;"><?php echo $form->labelEx($model,Yii::t('employees','Name')); ?></td>
  ...
  <tr>
    <td valign="top" width="45%"><?php echo $form->textField($model,'first_name',array('size'=>95,'maxlength'=>255)); ?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td valign="middle" style="padding-bottom:3px;"><?php echo $form->labelEx($model,Yii::t('employees','Description'),array('style'=>'float:left;')); ?>&nbsp;<span id="required" class="required" style="visibility:hidden; display:inline">*</span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<div class="formConInner">
<h3><?php echo Yii::t('employees','Fee Particulars');?></h3>
<table style="background-color: #c5ced9;color: #405875;font-weight: bold; padding: 10px 15px ;position: relative;"width="98%">
<tbody>
<tr>
<td width="19%">
<label>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
      <!--<td valign="middle"><?php echo $form->labelEx($model,Yii::t('employees','Name')); ?></td>-->
    ...
    <!--<td valign="middle">&nbsp;</td>-->
    <!--<td valign="middle"><?php echo $form->labelEx($model,Yii::t('employees','TAX')); ?></td>-->
    <td><?php echo $form->dropDownList($model,'marital_status',array('Single'=>'No Tax','Married'=>'User Fees','Divorced'=>'Service Tax')); ?>
    ...
    <td valign="middle"><?php echo $form->textField($model,'mother_name',array('size'=>15,'maxlength'=>255)); ?>
     ...
     <td valign="middle"><?php echo $form->dropDownList($model,'blood_group',array('A+' => '%', 'A-' => 'INR', 'B+' => '', 'B-' => '', 'O+' => '', 'O-' => '', 'AB+-' => '', 'AB-' => ''),
									array('empty' => 'Unknown')); ?>
  ...
  <tr>
    <!--<td valign="middle"><?php echo $form->labelEx($model,Yii::t('employees','Discount')); ?></td>-->
    
    <!--<td valign="middle">&nbsp;</td>-->
    <!--<td valign="middle"><?php echo $form->labelEx($model,Yii::t('employees','Description')); ?></td>-->
  ...
  <tr>
       <!--<td valign="middle"><?php echo $form->labelEx($model,Yii::t('employees','Percentage')); ?></td>-->
   
      <td valign="bottom">&nbsp;</td>
    <!--<td valign="middle"><?php echo $form->labelEx($model,Yii::t('employees','')); ?></td>
...
<div>
<h3><?php echo Yii::t('employees','Applicable to');?></h3>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <!--<td valign="middle"><?php echo $form->labelEx($model,Yii::t('employees','')); ?></td>-->
    <td><?php echo $form->dropDownList($model,'marital_status',array('Single'=>'Default','Married'=>'Admission Number',/*'Divorced'=>'Service Tax'*/)); ?>
		<?php echo $form->error($model,'marital_status'); ?></td>
    <!--<td valign="middle">&nbsp;</td>-->
    <!--<td valign="middle"><?php echo $form->labelEx($model,Yii::t('employees','Name')); ?></td>-->
    <td><?php echo $form->dropDownList($model,'marital_status',array('Single'=>'Default','Married'=>'Admission Number',/*'Divorced'=>'Service Tax'*/)); ?>
 ...
 <!-- <tr>
  ...
  <tr>
      <td><strong><a href="#">+Add access</a></strong></td></tr>
</table>
...
<table>
  ...
  <tr>
      <td><strong><a href="#">+Add Particular</a></strong></td></tr>
</table>
...
<div class="clear"></div>
	<div style="padding:0px 0 0 0px; text-align:left">
		<?php echo CHtml::submitButton($model->isNewRecord ? 'Setup Subscription »' : 'Save',array('class'=>'formbut')); ?>
	</div>
