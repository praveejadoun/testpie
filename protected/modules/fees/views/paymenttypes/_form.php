<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td><?php echo $form->labelEx($model,Yii::t('paymenttypes','type'),array('style'=>'float:left')); ?></td>
        ...
        <tr>
            <td><?php echo $form->labelEx($model,Yii::t('paymenttypes','status'),array('style'=>'float:left')); ?></td>
