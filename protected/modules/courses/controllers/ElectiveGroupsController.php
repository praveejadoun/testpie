...
class ElectiveGroupsController extends RController
{
	/**
	...
	public function actionAdmin()
	{
		$model=new ElectiveGroups('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ElectiveGroups']))
			$model->attributes=$_GET['ElectiveGroups'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='elective-groups-form')
		{
