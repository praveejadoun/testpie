...
class CoursesController extends RController
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','Managecourse','allcourses','commonsubjects','view1'),
				'users'=>array('@'),
			),
	...
	public function actionCreate()
	{
        ...
        public function actionDeactivatedbatches() {
            $this->render('deactivatedbatches',array(
			'model'=>$model,
                ));
        }
	...
	public function actionCommonsubjects() {
		...
		if(isset($_GET['Courses']))
		{
			...
			$list = $_GET['Courses'];
				...
				$this->redirect(array('view','courses'=>$model->id));
		}

		
            $this->render('commonsubjects',array(
			'model'=>$model,
                ));
