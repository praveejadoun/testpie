...
{?>
 ...
 <?php    $batch=Batches::model()->findByAttributes(array('id'=>$_REQUEST['id'])); 
    ...
    <?php if((Yii::app()->controller->id=='batches' and (Yii::app()->controller->action->id=='batchstudents' or Yii::app()->controller->action->id=='settings'or Yii::app()->controller->action->id=='waitinglist')) or (Yii::app()->controller->id=='subject' and Yii::app()->controller->action->id=='index') or (Yii::app()->controller->id=='weekdays' and (Yii::app()->controller->action->id=='timetable' or Yii::app()->controller->action->id=='index')) or (Yii::app()->controller->id=='classTiming' and Yii::app()->controller->action->id=='index') or (Yii::app()->controller->id=='studentAttentance' and Yii::app()->controller->action->id=='index') or (Yii::app()->controller->id=='gradingLevels' and Yii::app()->controller->action->id=='index') or (Yii::app()->controller->id=='exam' and Yii::app()->controller->action->id=='index') or (Yii::app()->controller->id=='batches' and (Yii::app()->controller->action->id=='studentelectives' or Yii::app()->controller->action->id=='electives'))or(Yii::app()->controller->id=='electives' and Yii::app()->controller->action->id=='index')or(Yii::app()->controller->id=='electiveGroups' and Yii::app()->controller->action->id=='index'))
			{
				?>
			...
			echo CHtml::ajaxLink('Change Batch',array('/site/explorer_2','widget'=>'2','rurl'=>$rurl[0]),array('update'=>'#explorer_handler'),array('id'=>'explorer_change','class'=>'sb_but','style'=>'top:-40px; right:40px;')); ?>
