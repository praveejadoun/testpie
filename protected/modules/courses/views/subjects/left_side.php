			...
			function t($message, $category = 'cms', $params = array(), $source = null, $language = null) 
{
    return $message;
			...
			'items'=>array(
						...
						array('label'=>Yii::t('Courses','List Courses & Batches').'<span>'.Yii::t('Courses','All Courses & Batches Details').'</span>', 'url'=>array('courses/managecourse'), 'active'=> ((Yii::app()->controller->id=='courses' and Yii::app()->controller->action->id=='managecourse,view') or Yii::app()->controller->id=='subjects' and (Yii::app()->controller->action->id=='create' or Yii::app()->controller->action->id=='update')),'linkOptions'=>array('class'=>'lbook_ico' )),
