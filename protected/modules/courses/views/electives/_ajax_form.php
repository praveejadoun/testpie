...
<?php   $formId='electives-form';
   ...
   ($model->isNewRecord)?CController::createUrl('electives/ajax_create')
    ...
    <div class="row">
            <?php echo $form->labelEx($model,Yii::t('Electives','name'), array('style'=>'color:#000000')); ?>
 ...
 <div class="row">
 	<?php echo $form->labelEx($model,Yii::t('Electives','code'), array('style'=>'color:#000000')); ?>
    ...
    <?php echo $form->error($model,'code'); ?>
        ...
        <div class="row" >
            <?php echo $form->labelEx($model,Yii::t('Electives','max_weekly_classes'),array('style'=>'color:#000000')); ?>
