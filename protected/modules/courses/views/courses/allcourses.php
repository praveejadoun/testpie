...
<h1><?php echo Yii::t('Courses','Manage All Courses & Batches');?></h1>
 ...
 <div class="formCon">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="s_search">
              			<tbody><tr>
                        	<td>&nbsp;</td>
                            <td style="width:100px;"><strong>Academic Year</strong></td>
                            <td>&nbsp;</td>
                            <td>
								<select style="width:190px;" onchange="getyear()" name="yid" id="yid">
<option value="">Select</option>
<option value="1" selected="selected">AY 2017-2018</option>
</select>                        	</td>
                    	</tr>
					</tbody></table>
                	</div>
 ...
 <?php $this->renderPartial('_flash');?>
    ...
    <div class="mcb_Con" style="padding: 0px 0px 0px 15px;">
...
<div class="mcbrow" id="jobDialog1">
	<ul>
    	<li style="padding: 8px 65px 8px 20px;" class="gtcol1" onclick="details('<?php echo $posts_1->id;?>');" style="cursor:pointer;">
      ...
      <!-- <li class="col4">
         <?php //echo CHtml::link(Yii::t('Courses','Add Subject')/*,$this->createUrl('batches/Addnew')*/,array('subject/index','id'=>$posts_1->id)
        /*'onclick'=>'$("#jobDialog").dialog("open"); return false;',
        'update'=>'#jobDialog','type' =>'GET','data' => array( 'val1' =>$posts_1->id ),'dataType' => 'text',),array('id'=>'showJobDialog1'.$posts_1->id *//*array('class'=>'add'));*/ ?>
        </li>-->
