...
<div style="padding:20px;">
 ...
 <div id="success_flash" align="center" style="padding-left:40px;  color:#F00; display:none;"><h4>Selected Subject Deleted Successfully !</h4>
    ...
    <div class="edit_bttns" style="top:-30px; right:-9px;">
    <ul>
    <li>
    <?php echo CHtml::link('<span>'.Yii::t('Electivegroups','Create Elective Groups').'</span>', array('#'),array('id'=>'add_electivegroup','class'=>'addbttn')) ?>
    </li> 
   
    <li>
    <?php echo CHtml::link('<span>'.Yii::t('Electivegroups','Electives').'</span>', array('/courses/electives','id'=>$_REQUEST['id']),array('class'=>'addbttn'));?>
...
//CREATE 
    ...
    $('#add_electivegroup ').bind('click', function() {
        $.ajax({
            type: "POST",
            url: "<?php echo Yii::app()->request->baseUrl;?>/index.php?r=courses/electiveGroups/returnForm",
