...
class TransportationController extends RController
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','create','update2','attendancelog','savesearch','DisplaySavedImage','pdf','Address','viewall','Addinfo','Remove'),
				'users'=>array('@'),
			),
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('studentssearch','update','batch','add'),
				'users'=>array('@'),
			),
	 ...
	 */
	public function actionStudentssearch()
	{
      		$model=new Employees;
		...
		$this->render('studentssearch',array(
			'model'=>$model,
		));
	}
