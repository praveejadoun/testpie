    ...
    return $message;
			...
			'items'=>array(
					...
					array('label'=>''.Yii::t('students','Create New Student').'<span>'.Yii::t('students','New Admission').'</span>',  'url'=>array('students/create') ,'linkOptions'=>array('class'=>'sl_ico' ),'active'=> (Yii::app()->controller->action->id=='create'  or Yii::app()->controller->id=='studentPreviousDatas' or Yii::app()->controller->id=='studentAdditionalFields'), 'itemOptions'=>array('id'=>'menu_1') 
                                        ...
                                        array('label'=>''.Yii::t('students','Manage Log Category').'<span>'.Yii::t('students','Manage Students Log Category').'</span>',  'url'=>array('/students/logcategory') ,'linkOptions'=>array('class'=>'sl_ico' ),'active'=> ((Yii::app()->controller->id=='logcategory') && (in_array(Yii::app()->controller->action->id,array('index'))) ? true : false), 'itemOptions'=>array('id'=>'menu_1') 
					       ),
						...
						array('label'=>''.Yii::t('onlineadmission','Online Applicants').'<span>'.Yii::t('onlineadmission','Manage Online Registrations').'</span>', 'url'=>array('/admin/onlineapplicants'),'active'=> ((Yii::app()->controller->id=='admin') && (in_array(Yii::app()->controller->action->id,array('onlineapplicants'))) ? true : false),'linkOptions'=>array('id'=>'menu_2','class'=>'lbook_ico')),
