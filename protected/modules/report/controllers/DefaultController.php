	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','assessment','update2','advancedreport','savesearch','DisplaySavedImage','pdf','Address','Employeeattendance','Studentattendance','Reminder'),
				'users'=>array('@'),
			),
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('studentexam','update','batch','add'),
				'users'=>array('@'),
			),
		...
		if(isset($_POST['Employees']))
		{
			...
			*/
			...
			//{
				...
				if($model->save())
				{
				$this->redirect(array('assessment','id'=>$model->id));
				}
			//}
		}
	...
	public function actionAdvancedreport()
	 {
	   ...
	   if((substr_count( $_REQUEST['name'],' '))==0)
		...
		$this->render('advancedreport',array('model'=>$model,
		'list'=>$posts,
		'pages' => $pages,
		'item_count'=>$total,
