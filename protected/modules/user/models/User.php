...
class User extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return ((get_class(Yii::app())=='CConsoleApplication' || (get_class(Yii::app())!='CConsoleApplication' && Yii::app()->getModule('user')->isAdmin()))?array(
			...
			array('password', 'length', 'max'=>128, 'min' => 1,'message' => UserModule::t("Incorrect password (minimal length 4 symbols).")),
			array('email', 'email'),
            ...
            array('lastvisit_at', 'default', 'value' => '2017-04-30 13:00:00', 'setOnEmpty' => true, 'on' => 'insert'),
