...
class GradingLevelsController extends RController
{
	/**
...
public function   init() {
  ...
  private function registerAssets(){
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('ajax_create','ajax_update','default'),
				'users'=>array('@'),
			),
	...
	{
		$model=GradingLevels::model()->findByPk($id);
		if($model===null)
	...
	{
		$check = GradingLevels::model()->findAllByAttributes(array('batch_id'=>$_REQUEST['id']));
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='grading-levels-form')
		{
        ...
        $this->renderPartial('view',array('model'=>$model),false, true);
             ...
             if(isset($_POST['update_id']))$model= $this->loadModel($_POST['update_id']);else $model=new GradingLevels;
...
//            $model= GradingLevels::model()->findAllByAttributes(array('batch_id'=>NULL));
		...
		if(isset($_POST['GradingLevels']))
		{
           $model=$this->loadModel($_POST['update_id']);
			$model->attributes=$_POST['GradingLevels'];
			if( $model->save(false)){
  ...
  public function actionAjax_Create(){
     ...
     public function actionAjax_delete(){
                ...
                exit;
                  ...
                  echo json_encode (array('success'=>false,'msg'=>notdeleted));
                  exit;
                           }
      }
