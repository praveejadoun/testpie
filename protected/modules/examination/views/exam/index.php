...
"#">Edit</a>    </li>
    ...
    <div class="clear"></div>
    <h1 style="border-bottom:1px solid #e2e8ed;margin: 0px 0px 0px 0px;padding:0px 0px 10px 0px;"><?php echo Yii::t('exam','Exams');?></h1>

    <div class="emp_cntntbx" style="padding-top:44px;">
...
<div class="c_subbutCon" align="right" style="width:100%">
    <div class="edit_bttns" style="width:250px; top:-39px; right:-20px;">
    <ul>
...
<?php echo CHtml::link('<span>'.Yii::t('Exam','Create Exam').'</span>', array('#'),array('id'=>'add_exam-groups','class'=>'addbttn')) ?>
 ...
 <li>
<?php echo CHtml::link('<span>'.Yii::t('Exam','Grading Levels').'</span>', array('/examination/gradingLevels','id'=>$_REQUEST['id']),array('class'=>'addbttn last')) ?>
 </li>
    </ul>
    </div>
    </div> 
             <?php echo CHtml::link('<span>close</span>',array('/examination'),array('class'=>'sb_but_close','style'=>'top:7px; right:0px;'));?>
			...
			array(
                   'class' => 'CButtonColumn',
                    'buttons' => array(
                                                        ...
                                                        'url'=>'Yii::app()->createUrl("/examination/examin/create", array("exam_group_id"=>$data->id,"id"=>$_REQUEST["id"]))', // a PHP expression for generating the URL of the button
