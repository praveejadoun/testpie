...
<div id="othleft-sidebar">
             <!--<div class="lsearch_bar">
                ...
                <div class="clear"></div>
  </div>-->    <h1><?php echo Yii::t('examination','EXAM MANAGEMENT');?></h1>   
                    <?php
			function t($message, $category = 'cms', $params = array(), $source = null, $language = null) 
{
    return $message;
			...
			'items'=>array(
					array('label'=>''.Yii::t('examination','Set Grading Levels').'<span>'.Yii::t('examination','Grading Levels For The Batch').'</span>', 'url'=>array('room/manage') ,'linkOptions'=>array('class'=>'lbook_ico'),
                                   'active'=> (Yii::app()->controller->id=='room' and (Yii::app()->controller->action->id=='manage') ? true : false),
					    ),  
						                
					array('label'=>''.Yii::t('examination','Select Course/Batch').'<span>'.Yii::t('examination','Select Batch and Exam').'</span>',  'url'=>array('room/searchroom'),'linkOptions'=>array('class'=>'sl_ico' ),'active'=> (Yii::app()->controller->id=='room' and (Yii::app()->controller->action->id=='searchroom')), 'itemOptions'=>array('id'=>'menu_1') 
					       ),
