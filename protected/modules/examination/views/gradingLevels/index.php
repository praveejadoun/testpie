...
<div class="right" align="left">
          ...
          ?>
            <?php  
                echo CHtml::link(Yii::t('Gradelevel','Create Grading Levels'), array('#'),array('id'=>'addn_grading-levels','class'=>'cbut'));?>
...
<?php
   ...
   ?>
   </div></div></div></div></div></div></td></tr></table></td></tr></table>
...
//CREATE 
    ...
    $('#addn_grading-levels ').bind('click', function() {
        $.ajax({
            type: "POST",
