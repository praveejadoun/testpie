...
<!--	<div class="sd_left">
        ...
        <ul>
            ...
            <li class="pro"><?php echo CHtml::link(Yii::t('app','Downloads'), array('/downloads')); ?></li>
             <li class="pro"><?php echo CHtml::link(Yii::t('app','Export'), array('/export')); ?></li>
             <li class="pro"><?php echo CHtml::link(Yii::t('app','Notify'), array('/notifications')); ?></li>
   ...
   <?php // $this->renderPartial('_partial',array('model'=>$model,'list'=>$posts,'item_count'=>$total,'name'=>'','ad'=>'','bat'=>''),false,true); ?>
	...
	{ ?>
        ...
        <?php  $this->renderPartial('batch_panel_examination',array()) ; ?>
