	...
	'columns'=>array(
		...
		array(
		 ...
		 array(            // display 'create_time' using an expression
            'name'=>'start_time',
			'type'=>'raw',
			'value'=>'ExaminController::convertTime($data->start_time)',

        ),
		 array(            // display 'create_time' using an expression
            'name'=>'end_time',
			'type'=>'raw',
			'value'=>'ExaminController::convertTime($data->end_time)',
		...
		*/
		array(
			...
			'buttons' => array(
                                                        ...
                                                        'url'=>'Yii::app()->createUrl("examination/examin/update", array("sid"=>$data->id,"exam_group_id"=>$data->exam_group_id,"id"=>$_REQUEST["id"]))', // a PHP expression for generating the URL of the button
