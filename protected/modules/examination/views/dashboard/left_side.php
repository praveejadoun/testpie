...
<div id="othleft-sidebar">
        ...
        <ul>
            <?php   if((Yii::app()->controller->id=='dashboard' || Yii::app()->controller->id=='default')  and Yii::app()->controller->action->id=='index') { ?>       
                ...
                <li>
                <li class="list_active"> 
                    <?php   if((Yii::app()->controller->id=='exam'and Yii::app()->controller->action->id=='index') || (Yii::app()->controller->id=='examin' and (in_array(Yii::app()->controller->action->id,array('create','update')))) || (Yii::app()->controller->id=='examScores' and (in_array(Yii::app()->controller->action->id,array('create','update'))))){ ?>       
			...
			$rurl = explode('&id=',$rurl[1]); 
              ...
              <?php } else { ?>
                <li>
                        <?php echo CHtml::link('Default Grading Levels<span>Set Default Grading Level</span>',array('gradingLevels/','id'=>$_REQUEST['id']),array('class'=>'sl_ico')); ?>
