    ...
    return $message;
			...
			'items'=>array(
					array('label'=>''.Yii::t('examination','Dashboard').'<span>'.Yii::t('examination','Examination Dashboard').'</span>', 'url'=>array('dashboard/') ,'linkOptions'=>array('class'=>'lbook_ico'),
                                                ...
                                                array('label'=>''.Yii::t('examination','Exams').'<span>'.Yii::t('examination','Examination List').'</span>',  'url'=>array('exams/'),'linkOptions'=>array('class'=>'sl_ico' ),'active'=> (Yii::app()->controller->id=='exams' and (Yii::app()->controller->action->id=='index' or Yii::app()->controller->action->id=='create')), 'itemOptions'=>array('id'=>'menu_1') 
                                                ),
                                        ...
                                        array('label'=>''.'<h1>'.Yii::t('examination','EXAM MANAGEMENT').'</h1>'), 
                                                array('label'=>Yii::t('examination','Select Course/Batch').'<span>'.Yii::t('examination','Select Batch And Exam').'</span>', 'url'=>array(''),'linkOptions'=>array('class'=>'abook_ico'),'active'=> (Yii::app()->controller->id=='result' and (Yii::app()->controller->action->id=='index')), 'itemOptions'=>array('id'=>'menu_1')
                                                    ),
                                                array('label'=>Yii::t('examination','Default Grading Levels').'<span>'.Yii::t('examination','Set Default Grading Level').'</span>', 'url'=>array('result/index'),'linkOptions'=>array('class'=>'abook_ico'),'active'=> (Yii::app()->controller->id=='result' and (Yii::app()->controller->action->id=='index')), 'itemOptions'=>array('id'=>'menu_1')
                                                    ),
