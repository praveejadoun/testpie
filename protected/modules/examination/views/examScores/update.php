...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <div class="emp_cntntbx">
    	<h1 style="border-bottom:1px solid #e2e8ed;margin: -25px 0px 0px 0px;padding:0px 0px 10px 0px;"><?php echo Yii::t('Examscore','Update Exam Score');?></h1>
<br/><br/><br/>
  <?php echo CHtml::link('<span>close</span>',array('/examination'),array('class'=>'sb_but_close','style'=>'top:35px; right:0px;'));?>
