	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','create','update2','Manage','savesearch','DisplaySavedImage','pdf','Address','Bookdetails','Addinfo','Remove'),
				'users'=>array('@'),
			),
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('booksearch','update','batch','add'),
				'users'=>array('@'),
			),
