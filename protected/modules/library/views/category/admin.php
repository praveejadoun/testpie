...
$this->breadcrumbs=array(
	'Library'=>array('default/index'),
        'Manage Book Category'=>array('category/manage'),
	'Manage',
);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="247" valign="top">
      ...
      <?php $this->renderPartial('/book/left_side');?>
    
    </td>
    <td valign="top">
    <div class="cont_right formWrapper">
<h1><?php echo Yii::t('category','Manage Book Categories');?></h1>
