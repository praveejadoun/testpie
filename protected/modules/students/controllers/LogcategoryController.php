...
class LogcategoryController extends RController
{
	/**
	...
	{
		$model=new StudentLogCategory;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['StudentLogCategory']))
		{
			$model->attributes=$_POST['StudentLogCategory'];
			if($model->save())
                            echo "<script type='text/javascript'>alert('Employee Log Created Successfully');</script>";
				
                            echo '<script>window.location.href = "'.Yii::app()->getHomeUrl().'?r=students/logcategory/index"</script>';
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['StudentLogCategory']))
		{
			$model->attributes=$_POST['StudentLogCategory'];
			if($model->save())
                            echo "<script type='text/javascript'>alert('Student Log Updated Successfully');</script>";
	...
	{
		$model= StudentLogCategory::model()->findByPk($id);
		if($model===null)
