...
class OnlineadmissionController extends RController
{
	/**
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','Onlineapplicants'),
				'users'=>array('*'),
			),
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('approval','incompletereg'),
				'users'=>array('@'),
			),
	...
	public function actionApproval()
	{
		...
		if(isset($_POST['Guardians']))
		{
			...
			if($model->save())
			{
				...
				$this->redirect(array('onlineapplicants','id'=>$model->ward_id));
			}
		}
	...
	public function actionIncompletereg()
	{
		...
		if(isset($_POST['Guardians']))
		{
			...
			if($model->save())
			{
				if($_REQUEST['std']==NULL)
				{
					...
					$this->redirect(array('onlineapplicants','id'=>$_REQUEST['sid'],'gid'=>$_REQUEST['id']));
				}
				{
		...
		$this->render('incompletereg',array(
			'model'=>$model,
		));
	}
	public function actionOnlineapplicants()
	{
		...
		$this->render('onlineapplicants',array('model'=>$model));
	}
