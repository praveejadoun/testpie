...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <div class="cont_right formWrapper">
                     ...
                     <ul>
    <li>
           <?php echo CHtml::link('<span>'. Yii::t('Students','Create Log Category').'</span>', array('create'),array('class'=>'addbttn last')) ?>
            </li>
    </ul>
    <div class="clear"></div>
   </div>
		  ...
		  <tr >
                        <th width="70%" align="center"><?php echo Yii::t('Logcategory','Name');?></th>
                        <th  width="30%" align="center"><?php echo Yii::t('LogCategory','Action');?></th>
			
		  </tr>
                  
          <?php
          
          $logcategory= StudentLogCategory::model()->findAll("is_deleted=:y", array(':y'=>0)); ?>
                                            ...
                                            <div class="gridact_drop" style="right:46px;" id="<?php echo $logcategory_1->id ?>a">
                                                <div class="gridact_arrow"></div>
                                                    <ul>
                                                        ...
                                                        <li><a href="index.php?r=students/logcategory/update&id=<?php echo $logcategory_1->id;?>" class="gredit">Edit</a></li>
  ...
  //'Logcategory','Delete'), array('delete', 'id' =>$logcategory_1->id),array('confirm'=>"Are you sure?\n\n Note: All details (students, timetable, fees, exam) related to this batch will be deleted.")); ?>
                  ...
                  <tr>
                      ...
                      <td colspan="4" style="font-size: 13px;"><?php echo "Log Categories are not available !";?></td>
                  </tr>
                   <?php } ?>
                   <?php
