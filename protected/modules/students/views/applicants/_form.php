...
if (Yii::app()->controller->action->id == 'create') {
    ...
    $reg_date = $adm_no->registration_date;
}
?>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td style="padding-left:8px;">
                    <?php
                    echo $form->textField($model, 'registration_no', array('size' => 20, 'maxlength' => 255, 'value' => $adm_no_1, 'disabled' => true,));
...
//echo $form->textField($model,'date_of_birth');
                    $this->widget('zii.widgets.jui.CJuiDatePicker', array(
                        ...
                        'options' => array(
                            'showAnim' => 'fold',
                            'dateFormat' => $date,
                            //'defaultDate'=>date("M d.y".strtotime($model->date_of_birth)),
                            'changeMonth' => true,
                            'changeYear' => true,
                            'yearRange' => '1900:'
                        ),
...
<?php echo $form->error($model, 'gender'); ?>
            ...
            <tr>
                <td valign="top">
                    ...
                    <?php
                    echo $form->dropDownList($model, 'blood_group', array('A+' => 'A+', 'A-' => 'A-', 'B+' => 'B+', 'B-' => 'B-', 'O+' => 'O+', 'O-' => 'O-', 'AB+' => 'AB+', 'AB-' => 'AB-'), array('empty' => 'Unknown'));
                    ?>
