...
<script>
    $(document).ready(function () {
        $("#guardians-form").submit(function () {
            ...
            var Name = document.getElementById('Guardians_relation').value;
            if (Name == "") //wanted to check for alphabets only.
            {
                alert("Please Select the Relation");
                return false; //doesnt go to next.php
            }
    ...
    function withoutSave() {
        window.location = "<?php echo Yii::app()->baseUrl; ?>/index.php?r=students/guardians/addguardian&id=<?php echo $_GET['id']; ?>"
            }
