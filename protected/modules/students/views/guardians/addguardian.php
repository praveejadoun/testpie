...
//echo Yii::app()->controller->action->id;
                ...
                <div style="padding:0px 0 0 0px; text-align:left;">
                    <?php echo CHtml::submitButton($model->isNewRecord ? 'Previous Details »' : 'Save', array('class' => 'formbut', 'id' => 'btn', 'name' => 'bbtn', 'title' => 'Save')); ?>
                    <input type="button" name="back" value="Continue Without Save" onclick="withoutSave();" class="formbut" style="float:right;"/>
...
<script>
    ...
    function withoutSave() {
        window.location = "<?php echo Yii::app()->baseUrl; ?>/index.php?r=students/studentPreviousDatas/create&id=<?php echo $_GET['id']; ?>"
            }
</script>