    ...
    $this->widget('zii.widgets.CMenu', array(
        ...
        'items' => array(
           ...
           /* array('label' => '' . Yii::t('students', 'Student Field Settings') . '<span>' . Yii::t('students', 'Add Additional Field') . '</span>', 'url' => array('formFields/list'), 'active' => ((Yii::app()->controller->id == 'settings') && (in_array(Yii::app()->controller->action->id, array('update', 'list',  'index'))) ? true : false), 'linkOptions' => array('id' => 'menu_2', 'class' => 'mg_ico')),*/
            ...
            array('label' => '' . Yii::t('students', 'Create New Applicant') . '<span>' . Yii::t('students', 'New Registration') . '</span>', 'url' => array('applicants/create'), 'linkOptions' => array('class' => 'sl_ico'), 'active' => ((Yii::app()->controller->id=='applicants' and Yii::app()->controller->action->id =='applicants/create')? true : false), 'itemOptions' => array('id' => 'menu_1')
            ),
