...
?>
    ...
    <!-- End Header -->
    <br /><br />
    <span align="center"><h4>STUDENTS LIST</h4></span>
   
    <table class="table_listbx" width="100%" cellspacing="0" cellpadding="0">
      
        <tr class="listbxtop_hdng">
            <td class="listbx_subhdng odd"><?php echo Yii::t('students','Student Name');?></td>
            <td class="listbx_subhdng odd"><?php echo Yii::t('students','Admission Number');?></td>
           
            
              <td class="listbx_subhdng odd"><?php echo Yii::t('students','Course/Batch');?></td>
         <td class="listbx_subhdng odd"><?php echo Yii::t('students','Gender');?>  </td></tr>
             <tr> <td class="subhdng_nrmal"><?php echo $model->first_name.' '.$model->last_name; ?></td>
             <td class="subhdng_nrmal"><?php echo $model->admission_no; ?></td>
