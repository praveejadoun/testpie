...
<table width="85%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="bottom" style="padding-bottom:3px;"><?php echo $form->labelEx($model,Yii::t('studentDocument','achievement_document_name')); ?></td>
    <td><p>Choose the file size is max. 200kb</p></td>
  </tr>
  <tr>
    <td valign="top" width="45%"><?php echo $form->textField($model,'achievement_document_name',array('size'=>32,'maxlength'=>255)); ?>
...
<div class="row">
		<?php //echo $form->labelEx($model,'achievdoc_file_size'); ?>
