        ...
        <div class="formConInner">
           <!-- <h3>Personal Details</h3>-->
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                <td valign="bottom" ><?php echo $form->labelEx($model,Yii::t('studentleavetype','Name <span class="required">*</span>')); ?></td>
                <td>&nbsp;</td>
                <!--<td valign="bottom"><?php //echo $form->labelEx($model,Yii::t('students','middle_name')); ?></td>
                <td>&nbsp;</td>-->
                <td valign="bottom"><?php echo $form->labelEx($model,Yii::t('studentleavetype','Code <span class="required">*</span>')); ?></td>
                </tr>
                <tr>
                <td valign="top"><?php echo $form->textField($model,'name',array('size'=>30,'maxlength'=>255)); ?>
                ...
                <td>&nbsp;</td>-->
                <td valign="top"><?php echo $form->textField($model,'code',array('size'=>25,'maxlength'=>255)); ?>
                ...
                <tr>
                <td valign="bottom"><?php echo $form->labelEx($model,Yii::t('studentleavetype','Label <span class="required">*</span>')); ?></td>
                <td>&nbsp;</td>
                <!--<td valign="bottom"><?php //echo $form->labelEx($model,Yii::t('students','date_of_birth')); ?></td>
                <td>&nbsp;</td>-->
                <td valign="bottom"><?php echo $form->labelEx($model,Yii::t('studentleavetype','Color Code <span class="required">*</span>')); ?></td>
                </tr>
                 <tr>
                <td valign="top"><?php echo $form->textField($model,'label',array('size'=>30,'maxlength'=>255)); ?>
                <?php echo $form->error($model,'label'); ?></td>
                <td>&nbsp;</td>
                <!--<td valign="top"><?php //echo $form->textField($model,'middle_name',array('size'=>10,'maxlength'=>255)); ?>
                <?php //echo $form->error($model,'middle_name'); ?></td>
                <td>&nbsp;</td>-->
                <td valign="top"><?php echo $form->textField($model,'colorcode',array('size'=>25,'maxlength'=>255)); ?>
                ...
                <tr>
                    <td>
                    <label class="required" style="float:left" for="StudentLeaveTypes_status">
                    Status
                    <span class="required">*</span>
                    </label>
                    </td>
                    <td class="cr_align">
                    <input id="ytStudentLeaveTypes_status" value="" name="StudentLeaveTypes[status]" type="hidden">
                    <input id="StudentLeaveTypes_status_0" dfault="active" value="active" checked="checked" name="StudentLeaveTypes[status]" type="radio">
                    <label for="StudentLeaveTypes_status_0">Active</label>
                    <input id="StudentLeaveTypes_status_1" dfault="inactive" value="inactive" name="StudentLeaveTypes[status]" type="radio">
                    <label for="StudentLeaveTypes_status_1">Inactive</label>
                    <div id="StudentLeaveTypes_status_em_" class="errorMessage" style="display:none"></div>
                    </td>
