...
class EmployeeDepartmentsController extends RController
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('EmployeeDepartments');
	...
	{
		$model=new EmployeeDepartments('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['EmployeeDepartments']))
			$model->attributes=$_GET['EmployeeDepartments'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='employee-departments-form')
		{
