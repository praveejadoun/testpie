...
class EmployeeCategoriesController extends RController
{
	/**
	...
	{
		$model=new EmployeeCategories('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['EmployeeCategories']))
			$model->attributes=$_GET['EmployeeCategories'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='employee-categories-form')
		{
