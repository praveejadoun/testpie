...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
   ...
   <!--     
    ...
    <div class="edit_bttns" style="width:280px; top:7px;right:0px;">
    <ul>
    <li>
    <?php echo CHtml::link('<span>'.Yii::t('Timing','Time Table').'</span>', array('/timetable/weekdays/timetable','id'=>$_REQUEST['id']),array('class'=>'addbttn'));?>
    </li>
    <li>
    <?php echo CHtml::link('<span>'.Yii::t('Timing','Create Class Timings').'</span>', array('#'),array('id'=>'add_class-timings','class'=>'addbttn last')) ?>
