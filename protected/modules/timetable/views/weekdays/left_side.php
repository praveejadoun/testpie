    ...
    return $message;
			...
			'items'=>array(
					...
					array('label'=>''.Yii::t('timetable','View Full Timetable').'<span>'.Yii::t('timetable','View Full Timetable').'</span>',  'url'=>array('weekdays/fulltimetable'),'linkOptions'=>array('class'=>'sl_ico' ),'active'=> (Yii::app()->controller->id=='weekdays' and (Yii::app()->controller->action->id=='fulltimetable')), 'itemOptions'=>array('id'=>'menu_1') 
						...
						array('label'=>Yii::t('timetable','Set Timetable').'<span>'.Yii::t('timetable','Timetable For The Batch').'</span>', 'url'=>array('weekdays/fulltimetable'),'linkOptions'=>array('class'=>'abook_ico'),'active'=> (Yii::app()->controller->id=='weekdays' and (Yii::app()->controller->action->id!='fulltimetable')? true : false), 'itemOptions'=>array('id'=>'menu_1')
                                                    ),
		  				array('label'=>Yii::t('timetable','Set Weekdays').'<span>'.Yii::t('timetable','Weekdays For The Batch').'</span>', 'url'=>array('weekdays/fulltimetable'),'linkOptions'=>array('class'=>'abook_ico'),'active'=> (Yii::app()->controller->id=='weekdays' and (Yii::app()->controller->action->id!='fulltimetable')? true : false), 'itemOptions'=>array('id'=>'menu_1')
                                                     ),
                                                array('label'=>Yii::t('timetable','Set Class Timing').'<span>'.Yii::t('timetable','Class Timing For The Batch').'</span>', 'url'=>array('weekdays/fulltimetable'),'linkOptions'=>array('class'=>'abook_ico'),'active'=> (Yii::app()->controller->id=='weekdays' and (Yii::app()->controller->action->id!='fulltimetable')? true : false), 'itemOptions'=>array('id'=>'menu_1')
                                                    ),
