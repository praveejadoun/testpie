...
{?>
 ...
 <?php    $batch=Batches::model()->findByAttributes(array('id'=>$_REQUEST['id'])); 
	...
	<div class="c_batch_tbar" style="padding:0px; margin:0px;width:720px;">
...
<?php 
			...
			{
				echo CHtml::ajaxLink('Change Batch',array('/site/explorer','widget'=>'2','rurl'=>'courses/batches/batchstudents'),array('update'=>'#explorer_handler'),array('id'=>'explorer_change','class'=>'sb_but','style'=>'top:13px; right:60px;'));
			}?>
            
            <?php echo CHtml::link('<span>close</span>',array('/timetable'),array('class'=>'sb_but_close','style'=>'top:13px; right:15px;'));?>
   
    	<div class="cb_left">
        	<ul>
            	<li><strong>Course :</strong> <?php echo $coursename; ?> </li>
                <li><strong>Batch :</strong> <?php echo $batchname; ?> </li>
